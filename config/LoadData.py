...
def load_trained_module(Module: nn.Module, saved_module_name):
    ...
    para_data_path = "config/Saved_paras/" + saved_module_name + ".pth"
...
def load_plot_data(saved_module_name):
    epoch_list = []
    loss_list = []
    plot_data_path = "config/Saved_plots/" + saved_module_name + ".txt"
...
def load_structure(saved_module_name):
    structure_data_path = "config/Saved_structures/" + saved_module_name + ".pkl"
